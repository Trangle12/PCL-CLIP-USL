...
def extract_cnn_feature(model, inputs,cams):
...
def extract_features(model, data_loader):
    ...
    labels = OrderedDict()
    with torch.no_grad():
        for i, (imgs, fnames, pids, camids, _) in enumerate(tqdm.tqdm(data_loader)):
            outputs = extract_cnn_feature(model, imgs,camids)
